...
/// @notice Deploy CompressedOracleV1 via CREATE3 for deterministic addresses across chains.
///
/// ENV:
...
///
/// Writes:
///   script/config/networks.json  → .{NETWORK}.deployments.compressedOracle
///
/// Usage:
///   NETWORK=base DEPLOY_VERSION=v1 forge script script/l2/DeployCompressedOracle.s.sol \
///     --rpc-url $RPC_URL --broadcast
contract DeployCompressedOracleL2 is NetworkConfig {
